    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-session">
            <a href="schedule.php" class="non-style-link-menu">
                <div>
                    <p class="menu-text">Scheduled Appointments</p>
                </div>
            </a>
        </td>
    </tr>
                            ...
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <br><br><br><br>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=session&id=' . $docid . '&name=' . $name . '"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Appointments</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if ($_GET) {
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to Doctors Scheduled Appointments?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            You want to view All Scheduled Appointments by <br>(' . substr($name, 0, 40) . ').

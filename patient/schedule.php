            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">
                        <?php echo $searchtype . " Appointment" . "(" . $result->num_rows . ")"; ?>
                    </p>
                        ...
                        <div class="abc scroll">
                            <table width="100%" class="sub-table scrolldown" border="0"
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Appointment &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <div class="h3-search">
                                                            Doctor name: ' . substr($docname, 0, 30) . '
                                                            </div>
                                                            <div class="h4-search">
                                                            Appointment Scheduled Date:' . $scheduledate . '
                                                            </div>
                                                            <br>

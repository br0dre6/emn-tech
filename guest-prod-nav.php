...
<body>
  ...
  <form action="">
    <div class="container">
      <div class="filter-head d-flex justify-content-between">
        <div>
          <select class="form-select" aria-label="Sortby" id="sort">
            <option selected>Popular</option>
            <option>Newest</option>
            <option>Oldest</option>
          </select>
        </div>
        <button type="reset" class="btn btn-secondary filter-button" id="filter-by-button" data-bs-toggle="tooltip"
      ...
      <div class="wrapper">
        ...
        <div class="container-fluid">
          <div class="row guest-product-card-list mb-3">
        ...
        <nav aria-label="Product Page Pagination">
          <ul class="pagination justify-content-center">
            <li class="page-item disabled">
              <a class="page-link unset" href="#" tabindex="-1" aria-disabled="true">Previous</a>
            </li>
  ...
  <script src="./js/guest-prod-nav.js"></script>
  <script>

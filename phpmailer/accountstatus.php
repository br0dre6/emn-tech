...
//Email body
	if($accountType =="admin"){
		...
		$mail->Body = "Hello $clientFirstName
 
		We've received your request to reset your Gnance password.
		
		Click <a href='http://localhost/phpprograming/thesisA/client/resetpassword.php?id=$email&token=$token'>Here</a> 
...
ini_set("thegnance.com",1);
error_reporting(E_ALL);
// WHEEEN GO DADDY MAILLERRRR 
$to = $clientEmail;
$subject = 'GNANCE ACCOUNT';
$from = 'thegnance.com';
...
$sendMessage = "
    <html>
        <body>
            <h1>Hi $clientEmail</h1>
            <p>
            Your account status in gnance has been change to $clientAccountStatus
            </p>
        </body>
    </html>
";

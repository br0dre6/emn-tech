...
<body>
        ...
        <div class="home-content">
            <div class="container-fluid">
                <div class="d-flex justify-content-end mx-2">
                    <!-- Archives Button -->
                    <a href="./admin-prod.php" class="btn btn-primary text-white fw-bold px-4" id="archive-list-button"
                        title="View Archive List">
                        View Products
                    </a>

                    <!-- Create New Product -->
                    <a href="./admin-add-prod.php" class="btn addBtn text-white fw-bold px-3 mx-3"
                        id="create-new-button" title="Create New Attendant">
                ...
                <!-- Product List Table -->
                <h2>List of Archive Products</h2>
                <div class="row">
                    <div class="col-lg mb-3"></div>
                    <div class="col-lg mb-3">
                        <input class="form-control oval-border product-search" type="text" placeholder="Search"
                            value="" />
                    </div>
                </div>
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title modal-title-2" id="exampleModalLongTitle"><!-- JQUERY CODE -->
                                </h5>
    ...
    <script src="../js/admin/admin-archive.js"></script>

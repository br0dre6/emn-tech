...
<body>
    ...
    <div class="home-content pb-3">
      <div class="container-fluid">
        <div class="d-flex mb-4 px-1">
          ...
          <span class="page-title px-3">Edit Product</span>
        </div>
        <form id="product-div" class="admin-edit-prod">
          <input class="admin-edit-prod-hidden" type="hidden" name="adminEditProdHidden" value="false" />
          <div class="container">
            <!-- Prodduct Image -->
  ...
  <script src="../js/admin/admin-edit-prod.js"></script>
